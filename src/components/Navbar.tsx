...
const Navbar: React.FC = ({}) => {
  ...
  const userProfile = (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="dark w-56" align="end" forceMount>
  ...
  return (
    <header className="flex items-center justify-between w-screen bg-dark p-4 px-5 h-16 bg-neutral-950">
