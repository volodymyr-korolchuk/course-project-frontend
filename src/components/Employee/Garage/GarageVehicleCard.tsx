...
const GarageVehicleCard: React.FC<VehicleCardProps> = ({ vehicle }) => {
  return (
    <div className="rounded-md flex flex-col">
      ...
      <div className="flex flex-col gap-2 p-4 border-t-2 bg-indigo-100 rounded-b-md text-black border-neutral-600">
        <div className="flex justify-between">
          ...
          {/* <Link
            to={`${ROUTES.employee.garage}/${vehicle.id}`}
            className="w-1/3"
          >
        ...
        <div>
          ...
          <div className="flex overflow-hidden text-nowrap items-center gap-1 ">
            <p className="font-semibold text-black text-sm">Located at:</p>{" "}
            <p
